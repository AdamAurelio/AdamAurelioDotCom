        ...
        <section className="py-20 px-4 md:px-8 bg-white">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <a
                href="#technology"
                className="group bg-gradient-to-br from-gray-50 to-gray-100 p-8 rounded-xl border-2 border-gray-200 hover:border-blue-500 transition-all hover:shadow-xl"
              >
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  Technology
                </h3>
                <p className="text-gray-600 mb-4 leading-relaxed">
                  Thoughts on software development, tools, and tech trends
                </p>
              ...
              >
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  Reflections on faith, scripture, and spiritual growth
                </p>
                <span className="text-blue-600 font-semibold group-hover:translate-x-2 inline-block transition-transform">
                  →
                </span>
              ...
              >
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  Life lessons from coaching youth soccer and family adventures
                </p>
                <span className="text-blue-600 font-semibold group-hover:translate-x-2 inline-block transition-transform">
                  →
                </span>
